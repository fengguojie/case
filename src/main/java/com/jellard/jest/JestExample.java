...
//		updateDocument("article", "article", "1");
//		getDocument("article", "article", "1");
...
//	}
	...
	private static void searchAll() throws Exception {
		...
		System.out.println("本次查询共查到："+count+"篇文章！");
	}
	...
	private static void createIndex() throws Exception {
		...
		JestResult jestResult1 = client.execute(index1);
		System.out.println(jestResult1.getJsonString());
		JestResult jestResult2 = client.execute(index2);
		System.out.println(jestResult2.getJsonString());
		JestResult jestResult3 = client.execute(index3);
